        ...
        <div className="bg-white rounded-3xl shadow-md">
          ...
          <div className="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
            ...
            <button
              ...
              className="bg-red-600 hover:bg-red-700 text-white py-2 px-6 rounded-full shadow-md transition-colors duration-300 flex items-center"
            >
              ...
              <div>
                ...
                {isLoading ? (
                  ...
                  <div className="text-center py-20">
                    ...
                    <button
                      onClick={handleRequestBlood}
                      className="mt-4 bg-red-600 hover:bg-red-700 text-white py-2 px-4 rounded-full text-sm inline-flex items-center"
                    >
            ...
            {activeTab === 'donors' && (
              <div>
                ...
                <div className="text-center py-12">
                  ...
                  <button
                    onClick={handleRequestBlood}
                    className="mt-4 bg-red-600 hover:bg-red-700 text-white py-2 px-4 rounded-full text-sm"
                  >
