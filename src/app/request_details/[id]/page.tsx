      ...
      <div className="min-h-screen bg-gray-50 p-8">
        <div className="max-w-3xl mx-auto bg-white rounded-lg shadow p-6">
          ...
          <Link 
            ...
            className="text-[#e56f6f] hover:text-[#d05a5a] font-medium"
          >
            Return to Dashboard
          </Link>
        </div>
        ...
        <div className="bg-white rounded-lg shadow overflow-hidden">
          ...
          <div className="border-b border-gray-200 bg-gray-50 px-6 py-4">
            <div className="flex flex-wrap items-center justify-between">
              ...
              <Link
                href="/dashboard/clinic"
                className="mt-2 sm:mt-0 text-[#e56f6f] hover:text-[#d05a5a] text-sm font-medium"
              >
                ← Back to Dashboard
              </Link>
            </div>
            ...
            <div className="flex justify-between items-center">
              ...
              <div className="flex items-center">
                ...
                <button
                  ...
                  className={`px-4 py-2 bg-[#e56f6f] hover:bg-[#d05a5a] text-white rounded-md text-sm font-medium ${
